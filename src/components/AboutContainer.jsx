const AboutContainer = ()=> {
    return(
        <section className="about-container">
            <h2>Sobre</h2>
            <p>Graduado em Tecnologia em Análise e Desenvolvimento de Sistemas pela UTFPR, em 2021.</p>
            <p>iniciei na área sem experiência prévia, mas superei os desafios com determinação e capacidade de aprendizado rápido.</p>
